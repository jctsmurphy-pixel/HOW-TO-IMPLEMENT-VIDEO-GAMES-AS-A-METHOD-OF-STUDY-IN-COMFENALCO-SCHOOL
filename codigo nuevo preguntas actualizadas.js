...
const subjectQuestions = {
  ...
  tecnologia: [],
  matematicas: [
    { question: "¿Cuánto es 5 + 7?", options: ["a) 10", "b) 11", "c) 12", "d) 13"], correct: "c" },
    { question: "¿Cuál es la raíz cuadrada de 81?", options: ["a) 9", "b) 8", "c) 7", "d) 10"], correct: "a" },
    { question: "Si un triángulo tiene lados 3, 4 y 5, es", options: ["a) Equilátero", "b) Isósceles", "c) Escaleno", "d) Rectángulo"], correct: "d" }
  ]
};
